...
function postForm($return){
	...
	if(isset($_SESSION['posts_var'])){
		if($_SESSION['posts_var'] == 0){
			...
			echo '<div style="background-color: #999945; width:500px; border:2px solid black; border-radius: 10px; padding: 10px;">';
			...
			echo '<table style="border:0px solid black;">
				...
				Message title: <input type = "text" name="Title"  maxlength="20" value = "';if(isset($Title)){ echo $Title;} echo'" /><br /><br />
				Message:<BR />
